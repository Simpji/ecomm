    ...
    <div>
      ...
      <h1 className='text-2xl my-5 uppercase font-bold text-center'>{productItems?.name} Details</h1>
          ...
          <div>
            ...
            <img src={selectedImages} width="400px"  alt="" />
          </div>
          <div>
              <div className='card-body'>
                  ...
                  <button onClick={() => addToCart( productItems._id, 1 , productItems)}  type="submit" className='product-btn p-2 text-[#fff] rounded capitalize hover:bg-[#A42CD6] bg-[#502274]'>Add to Cart</button>
               </div>
