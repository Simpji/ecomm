        ...
        <div className='p-3 bg-[#fff] card'>
          <img src={product_item_prop.images[0].img} alt="" />
            ...
            <div className='card-body'>
                ...
                <h5 className='text-xl font-bold uppercase pt-3 pb-2'>NGN{product_item_prop.price}</h5>
                <p className='pb-5'>{product_item_prop.description}</p>
                <Link to={`/details/${product_item_prop._id}`}className='product-btn p-2 text-[#fff] rounded capitalize  hover:bg-[#A42CD6] bg-[#502274] me'>See more</Link>
            </div>
        </div>
       </div>
    </div>
